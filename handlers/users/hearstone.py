    ...
    while True:
        ...
        if new_update != last_update:
            ...
            await bot.send_message(
                chat_id=chat_id,
                text=f'New update for hearthstone: {last_update}',
            )
...
async def update():
    ...
    print("last updates hearthstone: ", last_update)
    return last_update




@dp.message_handler(commands='hearthstone')
async def cmd_send_hearthstone(message: aiogram.types.Message):
    last_update = await update()
    await bot.send_message(
        chat_id=message.chat.id,
        text=f'last update for hearthstone: {last_update}',
    )
