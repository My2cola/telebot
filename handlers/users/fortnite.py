    ...
    while True:
        ...
        if new_update != last_update:
            ...
            await bot.send_message(
                chat_id=chat_id,
                text=f'New update for fortnite: {last_update}',
            )
...
async def update():
    ...
    print("last updates fortnite: ", last_update)
    return last_update



@dp.message_handler(commands='fortnite')
async def cmd_send_fortnite(message: aiogram.types.Message):
    last_update = await update()
    await bot.send_message(
        chat_id=message.chat.id,
        text=f'last update for fortnite: {last_update}',
    )
